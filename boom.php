...
function view($url,$agent){
 $lian = curl_init();
 curl_setopt($lian, CURLOPT_URL, $url);
 curl_setopt($lian, CURLOPT_REFERER, "https://www.google.com");
 curl_setopt($lian, CURLOPT_REFERER, "https://bing.com");
 curl_setopt($lian, CURLOPT_REFERER, "https://detik.com");
 curl_setopt($lian, CURLOPT_REFERER, "https://www.google.co.id");
 curl_setopt($lian, CURLOPT_REFERER, "https://tools.zone-xsec.com");
 curl_setopt($lian, CURLOPT_REFERER, "https://www.damentaweb.my.id");
 curl_setopt($lian, CURLOPT_REFERER, "https://web.whatsapp.com");
 curl_setopt($lian, CURLOPT_HEADER, 0);
 curl_setopt($lian, CURLOPT_FOLLOWLOCATION, true);
 curl_setopt($lian, CURLOPT_RETURNTRANSFER, true);
 curl_setopt($lian, CURLOPT_SSL_VERIFYPEER, false);
 curl_setopt($lian, CURLOPT_TIMEOUT, 1);
 curl_setopt($lian, CURLOPT_USERAGENT, $agent);
 curl_setopt($lian, CURLOPT_ENCODING, "gzip");
 $outp = curl_exec($lian);
 $data = curl_getinfo($lian);
 curl_close($lian);
